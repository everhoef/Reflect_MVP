...
import { GuidanceSidebar } from '@/modules/facilitation/components/retro/GuidanceSidebar'
import type { HistoryMessage, PrivateCoachingNote, FacilitatorQuickActionsConfig } from '@/modules/facilitation/components/retro/GuidanceSidebar'
